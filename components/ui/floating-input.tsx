  ...
  return (
    <div className="relative">
      <input
        ...
        aria-invalid={!!error}
        className={cn(
          "peer h-14 w-full rounded-xl border bg-card-50 px-4 pt-5 pb-2 text-base transition-colors duration-200",
          "border-input",
      ...
      <label
        ...
        className={cn(
          ...
          "peer-placeholder-shown:top-[50%] peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:bg-transparent peer-placeholder-shown:px-0 peer-placeholder-shown:ml-0 peer-placeholder-shown:text-base peer-placeholder-shown:font-normal",
          "peer-focus:top-0 peer-focus:-translate-y-1/2 peer-focus:bg-card-50 peer-focus:px-1 peer-focus:ml-[-4px] peer-focus:text-xs peer-focus:font-medium peer-focus:text-primary",
