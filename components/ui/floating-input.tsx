  ...
  return (
    <div className="relative">
      <input
        ...
        aria-invalid={!!error}
        className={cn(
          "peer h-14 w-full rounded-xl border bg-card-back px-4 pt-4 pb-2 text-base transition-colors duration-200",
          "border-input",
      ...
      <label
        ...
        className={cn(
          ...
          "peer-focus:top-0 peer-focus:-translate-y-1/2 peer-focus:bg-card-back peer-focus:px-1 peer-focus:ml-[-4px] peer-focus:text-xs peer-focus:font-medium peer-focus:text-primary",
  ...
  return (
    <div className="relative">
      <textarea
        ...
        aria-invalid={!!error}
        className={cn(
          "peer min-h-[120px] w-full rounded-xl border bg-card-back px-4 pt-6 pb-3 text-base transition-colors duration-200 resize-none",
          "border-input",
          "focus:border-primary",
          "outline-none ring-0 focus:ring-0 focus:outline-none focus-visible:ring-0 focus-visible:outline-none",
          "disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
