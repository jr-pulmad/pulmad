    ...
    <div className="relative">
      ...
      <label
        ...
        className={cn(
          ...
          "peer-focus:top-0 peer-focus:-translate-y-1/2 peer-focus:bg-[#1a1a1a] peer-focus:px-1 peer-focus:ml-[-4px] peer-focus:text-xs peer-focus:font-medium peer-focus:text-primary",
