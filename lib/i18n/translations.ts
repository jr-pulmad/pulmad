  ...
  et: {
    ...
    menu: {
      ...
      mainCourseOptions: {
        ...
        option1: "Pardirind röstitud juurviljadega",
        option2: "Grillitud veisetükk (Beef Steak)",
      },
  ...
  en: {
    ...
    menu: {
      ...
      mainCourseOptions: {
        ...
        option1: "Duck breast with roasted root vegetables",
        option2: "Grilled beef steak",
      },
